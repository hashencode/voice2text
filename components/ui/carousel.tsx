...
export const Carousel = forwardRef<CarouselRef, CarouselProps>(
    (
        ...
        const goToNext = useCallback(() => {
            ...
            const targetIndex = nextIndex < children.length ? nextIndex : loop ? 0 : currentIndexRef.current;
        ...
        const goToPrevious = useCallback(() => {
            ...
            const targetIndex = prevIndex >= 0 ? prevIndex : loop ? children.length - 1 : currentIndexRef.current;
            if (targetIndex !== currentIndexRef.current) {
                setCurrentIndex(targetIndex);
                setIsUserInteracting(true);
                scrollToIndex(targetIndex);
        ...
        const startAutoPlay = useCallback(() => {
            ...
            autoPlayTimerRef.current = setInterval(() => {
                const nextIndex = currentIndexRef.current + 1;
                const targetIndex = nextIndex >= children.length ? (loop ? 0 : currentIndexRef.current) : nextIndex;
        ...
        }, [autoPlay, autoPlayInterval, children.length, loop, isUserInteracting, clearTimers, scrollToIndex]);
