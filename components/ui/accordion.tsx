...
export function Accordion({ type, collapsible = false, defaultValue, value: controlledValue, onValueChange, children }: AccordionProps) {
    const [internalValue, setInternalValue] = useState<string | string[]>(defaultValue || (type === 'multiple' ? [] : ''));
