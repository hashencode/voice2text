    ...
    (
        ...
        const pinchGesture = Gesture.Pinch()
            ...
            .onEnd(() => {
                ...
                zoomTextAnim.value = withSequence(withTiming(1, { duration: 200 }), withDelay(1000, withTiming(0, { duration: 200 })));
            });
        ...
        if (!permission) {
            return (
                <View style={[styles.container, { backgroundColor }, style]}>
                    ...
                    <TextX style={[styles.loadingText, { color: textColor }]}>Loading camera...</TextX>
                </View>
            );
        }
                ...
                <View style={[styles.cameraContainer, { height: getCameraHeight() }]}>
                    <GestureDetector gesture={composedGestures}>
                        <AnimatedCameraView
                            ...
                            <Animated.View style={[styles.zoomIndicator, animatedZoomTextStyle]} pointerEvents="none">
                            ...
                            {isRecording && (
                                <View style={styles.recordingIndicator}>
                                    ...
                                    <TextX style={styles.recordingText}>REC {formatTime(recordingTime)}</TextX>
                                </View>
                            )}
                            {showControls && (
                                <>
                                        ...
                                        <TouchableOpacity
                                            style={[
                                                styles.captureButton,
                                                {
                                                    ...
                                                    borderColor: mode === 'video' && isRecording ? destructiveColor : primaryColor,
                                                },
                                            ...
                                            {isCapturing ? (
                                                ...
                                                <View
                                                    style={[
                                                        styles.captureInner,
                                                        {
                                                            backgroundColor: mode === 'video' && isRecording ? 'white' : primaryColor,
