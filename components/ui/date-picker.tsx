...
export function DatePicker(props: DatePickerProps) {
    ...
    const isRangeEndpoint = useCallback(
        (date: Date) => {
            ...
            const isStart = tempRange.startDate && new Date(tempRange.startDate).setHours(0, 0, 0, 0) === normalizedDate.getTime();
            const isEnd = tempRange.endDate && new Date(tempRange.endDate).setHours(0, 0, 0, 0) === normalizedDate.getTime();
            ...
            <View
                ...
                {DAYS.map(day => (
                    <View
                        ...
                        <TextX variant="body" style={{ fontSize: 12, fontWeight: '600' }}>
                            {day}
                        </TextX>
                    </View>
                ))}
                ...
                {calendarData.weeks.map((week, weekIndex) => (
                    <View
                        ...
                        {week.map((day, dayIndex) => {
                            ...
                            const rangeEndpoints = dayDate ? isRangeEndpoint(dayDate) : { isStart: false, isEnd: false };
                                            ...
                                            style={[
                                                {
                                                    width: 40,
                                                    height: 40,
                                                    borderRadius: rangeEndpoints.isStart || rangeEndpoints.isEnd ? 0 : CORNERS,
                                                    backgroundColor:
                    ...
                    <View className="flex-1">
                        ...
                        <ScrollView
                            ...
                            {Array.from({ length: timeFormat === '12' ? 12 : 24 }, (_, i) =>
                                ...
                                const actualHour = timeFormat === '12' ? (hour === 12 ? (isPM ? 12 : 0) : isPM ? hour + 12 : hour) : hour;
