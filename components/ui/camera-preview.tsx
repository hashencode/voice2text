...
export function CameraPreview() {
    ...
    const handleUploadAction = () => {
        ...
        Alert.alert(
            'Upload Action',
            `${capturedMedia.type === 'picture' ? 'Photo' : 'Video'} ready for processing.\n\nCheck console for media details.`,
            [
                {
                    text: 'Continue',
                    onPress: () => {
    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor }]}>
            <View style={styles.content}>
                <TextX variant="heading" style={styles.title}>
                    Camera Component
                </TextX>

                <TextX variant="body" style={styles.description}>
                    Tap the button below to open the camera and capture photos or videos. After capturing, you can preview, save, or process
                    your media.
                </TextX>

                <View style={styles.buttonContainer}>
                    <ButtonX variant="default" size="lg" onPress={handleOpenCamera} style={styles.button}>
                        Open Camera
                    </ButtonX>
                </View>
            </View>
