...
const ReanimatedProgress = ({ duration, currentTime, onSeek, onSeekStart, onSeekEnd }: ReanimatedProgressProps) => {
    ...
    return (
        <GestureDetector gesture={composedGesture}>
            <Animated.View style={progressStyles.container} onLayout={e => setBarWidth(e.nativeEvent.layout.width)}>
                    ...
                    <Animated.View style={[styles.controlsContainer, controlsAnimatedStyle]} pointerEvents="box-none">
                        ...
                        <View style={styles.bottomControls}>
                            <View style={styles.timeContainer}>
                                <Text style={[styles.timeText, { color: mutedColor }]}>{formatTime(currentTime)}</Text>
